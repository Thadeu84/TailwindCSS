export const TestmonialItem = () => {
    return (
        <div className="bg-gray-100 p-8 shadow-sm rounded-xl overflow-hidden md:flex md:p-0">
            ...
            <div className="pt-6 text-center space-y-4 md:text-left md:p-8">
                 <div className="text lg font-semibold">
                    ...
                    mas depois de uma ano estudando quando tinha tempo,
                    consegui um emprego de desenvolvedor frontend."
                 </div>       
                 <div className="font-medium">
                     <div className="text-blue-600">Thadeu Guimarães</div>
